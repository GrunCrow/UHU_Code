...
public class ClienteMovil extends Cliente {
	...
	public void setFPermanencia(Fecha fechaper) {
		this.fechaPermanencia = (Fecha)fechaper.clone(); //(Fecha)fechaper.clone();
	...
	@Override //necesito implementarlo en la principal para que la class Empresa lo detecte
    ...
    @Override
    public Object clone(){
        return new ClienteMovil(getNIF(), getNombre(), getFechaNac(), getFechaAlta(), getFPermanencia(), 
        			getMinutos(), getPrecioMinuto());
    }
    @Override
