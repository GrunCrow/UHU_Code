...
public class Cliente implements Cloneable, Proceso{
	...
	public Cliente(Cliente c1) {
		...
		this.fechaNac = (Fecha)c1.fechaNac.clone(); //si no ponemos clone hacemos que apunte a 
													//la misma fecha
		this.fechaAlta = (Fecha)c1.fechaAlta.clone(); //y al mostrar si cambiamos esa fecha o la otra, 
													  //cambia a lo q apunta (cambian ambas)
