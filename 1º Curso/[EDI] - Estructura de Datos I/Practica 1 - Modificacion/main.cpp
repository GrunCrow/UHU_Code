       ...
       switch(op){
           ...
           case 1:
            ...
            case 5:{
                ...
                cout<<"\nIntroduce la hora de fin de los itinerarios a buscar: ";
                cin>>ho.h;
                cout<<"\nIntroduce los minutos de fin de los itinerarios a buscar: ";
                cin>>ho.m;
                cout<<"\nIntroduce si es am(1) o no(0) ";
                cin>>ho.am;
                cout<<endl<<"Introduzca el destino: ";
                cin>>dest;

                system("cls");

                it.MostrarITI(ho,dest);
