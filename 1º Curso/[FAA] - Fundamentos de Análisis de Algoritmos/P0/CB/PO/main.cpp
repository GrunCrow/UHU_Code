...
void menu(void)
{
 ...
 while (opcion !=0)
 {
	 ...
	 switch (opcion)
	 {
		 ...
		 case 4:{
				cout << "Ordenacion del vector: " <<endl; cjt.escribe(); cout<<endl;
				cjt.ordena(MAXIMO);
				cout << "Vector ordenado: "<<endl; cjt.escribe(); cout<<endl;
				break;
				}
			case 5:{
				cout << "Vaciar el vector: " <<endl; cjt.escribe(); cout<<endl;
				cjt.vaciar();
				cout << "Vector inicializado (tamano=0): "<<endl; cjt.escribe(); cout<<endl;
				break;
				}
		 default:{
