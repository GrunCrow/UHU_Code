...
nombreFichero = "espacioCcas_A_C_D.mat";
load(pathActual + "DatosGenerados/" + nombreFichero);
nombreFichero = 'nombresProblema_knn_A_C_D.mat';
load(pathActual + "DatosGenerados/" + nombreFichero);
...
save(pathActual + 'DatosGenerados/descriptores_atributos_knn_A_C_D.mat','nombresProblema');
% save(pathActual + 'DatosGenerados/funcion_decision.mat','d');

save(pathActual + "DatosGenerados/espacioCcas_knn_A_C_D.mat","espacioCcas", 'XoI','YoI', 'nombresProblema')
