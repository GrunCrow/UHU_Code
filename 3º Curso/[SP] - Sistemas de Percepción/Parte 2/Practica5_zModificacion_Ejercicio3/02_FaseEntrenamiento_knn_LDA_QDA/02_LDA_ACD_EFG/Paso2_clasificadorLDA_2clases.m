...
nombreFichero = "espacioCcas_ACD_EFG.mat";
load(nombreFichero);
...
load(pathActual + "DatosGenerados/nombresProblema_LDA.mat");
% funcion_representa_muestras_clasificacion_binaria_con_frontera(XoI, YoI, nombresProblemaOI, coeficientes_d12)
save(pathActual + "DatosGenerados/espacioCcas_LDA_ACD_EFG.mat", "d12", "coeficientes_d12","espacioCcas", 'XoI','YoI', "nombresProblemaOI")
