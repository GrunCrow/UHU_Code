...
for i=1:numObjetos
    ...
    if posClaseOI == 8 % 8
        ...
        k = 5;
        tipoDistancia = "Euclidea";
        codifClases = unique(YTrain_17_23456);
        
        XoI_17_23456 = XImagenS(:, espacioCcas_17_23456);
        
        YoI_17_23456 = funcion_knn(XoI, XTrain_17_23456, YTrain_17_23456, k, tipoDistancia);
        posClaseOI = find(ismember(codifClases_17_23456, YiOI));
        ...
        if posClaseOI ~= 1
            ...
            subplot(1,2,2) % A - D
            funcion_representa_datos_dato(Z, Y, espacioCcas_1_7, nombresProblema_1_7, Xi)  
        end
