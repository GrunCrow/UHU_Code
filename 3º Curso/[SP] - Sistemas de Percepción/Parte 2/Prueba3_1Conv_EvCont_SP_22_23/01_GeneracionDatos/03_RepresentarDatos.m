...
% Compacticidad, Solidez Invariante a la Rotación y Momento de Hu Número 1
descriptores_mostrar =  [1 3 6]


% Compacticidad
j = descriptores_mostrar(1)
