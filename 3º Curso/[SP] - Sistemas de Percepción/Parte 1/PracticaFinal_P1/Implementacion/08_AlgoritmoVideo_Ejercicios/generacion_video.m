...
fichero = 'VariablesRequeridas\VideoSeguimiento_Multiple.avi';
...
output = VideoWriter(pathsArchivos + 'VariablesGeneradas\Deteccion_Multiple.mp4', 'MPEG-4');
...
%     areas = cat(1,stats.Area);
    ...
    if(~isempty(centroids))
        ...
        Io = funcion_visualiza(I,Ibcent & Ietiq == N(pos), rojo, false);
